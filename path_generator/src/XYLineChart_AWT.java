...
public class XYLineChart_AWT {
	...
	static {
		...
		robotPaths.put("CSR-2", new Path(new Waypoint[]{
				new Waypoint(130, 100, Pathfinder.d2r(0)),
				new Waypoint(103, 108, Pathfinder.d2r(-45)),
				new Waypoint(94, 129, Pathfinder.d2r(-90)),
				new Waypoint(95, 138, Pathfinder.d2r(-105)),
		},
				defaultConfig
		));
		...
		robotPaths.put("CSR-4", new Path(new Waypoint[]{
				new Waypoint(130, 100, Pathfinder.d2r(0)),
				new Waypoint(116, 106, Pathfinder.d2r(-45)),
				new Waypoint(108, 122, Pathfinder.d2r(-90)),
				new Waypoint(110, 134, Pathfinder.d2r(-120)),
		},
				slowConfig));
