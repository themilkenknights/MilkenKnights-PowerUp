...
public class StraightOpenLoopAction implements Action {

	private double time;
	private double speed;
	private Timer timer;

	public StraightOpenLoopAction(double time, double speed) {
		this.speed = speed;
		this.time = time;
		timer = new Timer();
	}
	...
	public void start() {
		timer.start();
		Drive.getInstance().setmDriveControlState(DriveControlState.OPEN_LOOP);
	}
