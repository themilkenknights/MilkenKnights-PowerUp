...
public class TalonSRXFactory {
    ...
    public static VictorSPX createPermanentSlaveTalon(int id, int master_id) {
        final VictorSPX talon = createVictor(id, kSlaveConfiguration);
    ...
    public static VictorSPX createVictor(int id, Configuration config) {
        ...
        talon.configForwardLimitSwitchSource(RemoteLimitSwitchSource.RemoteTalonSRX,
                LimitSwitchNormal.NormallyOpen, Constants.ELEVATOR.ELEVATOR_MASTER_TALON_ID, kTimeoutMs);
        talon.configReverseLimitSwitchSource(RemoteLimitSwitchSource.RemoteTalonSRX,
                LimitSwitchNormal.NormallyOpen, Constants.ELEVATOR.ELEVATOR_MASTER_TALON_ID, kTimeoutMs);
        talon.overrideLimitSwitchesEnable(config.ENABLE_LIMIT_SWITCH);
        ...
        talon.setStatusFramePeriod(StatusFrame.Status_1_General,
                config.GENERAL_STATUS_FRAME_RATE_MS, kTimeoutMs);
        talon.setStatusFramePeriod(StatusFrame.Status_2_Feedback0,
                config.FEEDBACK_STATUS_FRAME_RATE_MS, kTimeoutMs);
