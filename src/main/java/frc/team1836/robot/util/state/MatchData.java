...
public class MatchData {
	...
	public MatchData(DriverStation.MatchType matchType, int matchNumber, DriverStation.Alliance alliance, AutoChooser.GameObjectPosition switchPosition, AutoChooser.GameObjectPosition
			scalePosition) {
