...
public class Drive extends Subsystem {
    ...
    public synchronized void setVelocitySetpoint(DriveSignal signal) {
       ...
       // System.out.println("Left: " + leftDrive.getSpeed() + " Right: " + rightDrive.getSpeed() + " Error: " + Math.abs(leftDrive.getSpeed() - rightDrive.getSpeed()));
    }
    ...
    public void outputToSmartDashboard() {
        ...
        SmartDashboard.putNumber("Master Error",  Math.abs(leftDrive.getPercentOutput() - rightDrive.getPercentOutput()));
        SmartDashboard.putNumber("Slave Error",  Math.abs(leftDrive.getSlavePercentOutput() - rightDrive.getSlavePercentOutput()));
    }
