...
import frc.team1836.robot.auto.modes.SideSwitchMode;
import frc.team1836.robot.auto.modes.SingleSideSwitchMode;
...
public class AutoChooser {
	...
	public static void updateGameData() {
		...
		CrashTracker.logMarker(
				"Alliance: " + RobotState.matchData.alliance.toString() + " Match Number: "
						+ RobotState.matchData.matchNumber + " Match Type: " + RobotState.matchData.matchType
						.toString() + " Switch Position: " + RobotState.matchData.switchPosition.toString()
						+ " Scale Position: " + RobotState.matchData.scalePosition.toString());
	}
