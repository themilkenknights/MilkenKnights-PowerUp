...
public class PathFollower {
    ...
    public TrajectoryStatus getLeftVelocity(double dist, double vel, double angle, boolean connected) {
        return lFollower.calculate(dist, vel, angle, connected);
    }

    public TrajectoryStatus getRightVelocity(double dist, double vel, double angle, boolean connected) {
