...
public class Spline {
	...
	public static boolean reticulateSplines(double x0, double y0, double theta0,
		...
		// System.out.println(theta0_hat);
		// System.out.println(yp1_hat);
		//(0,0) - (2,2)
		//Inverse Tan (2,2)

    /*System.out.println("YP0 Hat " + Math.toDegrees(theta0_hat));
    System.out.println("YP1 Hat " + Math.toDegrees(result.theta_offset_));
    System.out.println("YP1 Hat " + Math.toDegrees(theta0));
    System.out.println("YP1 Hat " + Math.toDegrees(yp0_hat)); */
